...
#include "string.h"
	...
	word far* BytesPerSector;
	byte far* SectorPerCluster;
	word far* ReservedSectors;
	byte far* NumberOfFATs	;
	word far* RootEntries	;
	word far* TotalSectors	;
	byte far* MediaDescriptor;
	word far* SectorPerFat	;
	word far* SectorPerTrak	;
	word far* Heads			;
	byte far* PhysicalDiskNumber;
	char * NowDir;
	char NowDirS[20]="A:";
...
void ShowMemory();
void ShowDiskInfo();
void Dir(char far* baseptr,char * ptr);
